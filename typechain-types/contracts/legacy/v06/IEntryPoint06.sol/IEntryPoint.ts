...
export interface IEntryPointInterface extends Interface {
  ...
  encodeFunctionData(
    ...
    values: [UserOperation06Struct[], AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [UserOperation06Struct, AddressLike, BytesLike]
  ): string;
  encodeFunctionData(
...
export interface IEntryPoint extends BaseContract {
  ...
  ): TypedContractMethod<[userOp: UserOperation06Struct], [void], "nonpayable">;
  getFunction(
