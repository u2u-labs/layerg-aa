...
export interface TestExecAccountFactoryInterface extends Interface {
  getFunction(
...
export interface TestExecAccountFactory extends BaseContract {
  connect(runner?: ContractRunner | null): TestExecAccountFactory;
  waitForDeployment(): Promise<this>;

  interface: TestExecAccountFactoryInterface;
