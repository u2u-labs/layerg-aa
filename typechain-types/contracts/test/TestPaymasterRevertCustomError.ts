...
export interface TestPaymasterRevertCustomErrorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addStake"
      | "deposit"
...
export interface TestPaymasterRevertCustomError extends BaseContract {
  connect(runner?: ContractRunner | null): TestPaymasterRevertCustomError;
  ...
  setRevertType: TypedContractMethod<
    [_revertType: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "setRevertType"
  ): TypedContractMethod<[_revertType: BigNumberish], [void], "nonpayable">;
  getFunction(
